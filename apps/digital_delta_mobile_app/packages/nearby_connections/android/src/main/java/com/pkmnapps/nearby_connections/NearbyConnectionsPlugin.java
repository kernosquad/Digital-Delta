...
// setDisruptiveUpgrade(false) prevents Nearby from auto-enabling
                                // WiFi Direct. The connection stays on Bluetooth Classic only so
                                // the app never requires WiFi to be turned on.
